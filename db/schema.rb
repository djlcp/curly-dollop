...
ActiveRecord::Schema.define(version: 2019_12_05_235235) do
  ...
  create_table "employer_profiles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
  ...
  create_table "job_postings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "content"
