...
class EmployeeProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_profile" do
    assert_difference('EmployeeProfile.count') do
      post employee_profiles_url, params: { employee_profile: { date_of_birth: @employee_profile.date_of_birth, first_name: @employee_profile.first_name, last_name: @employee_profile.last_name } }
    end
  ...
  test "should update employee_profile" do
    patch employee_profile_url(@employee_profile), params: { employee_profile: { date_of_birth: @employee_profile.date_of_birth, first_name: @employee_profile.first_name, last_name: @employee_profile.last_name } }
